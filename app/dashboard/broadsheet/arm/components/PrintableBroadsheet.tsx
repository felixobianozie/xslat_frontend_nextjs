...
const PrintableBroadsheet = forwardRef<HTMLDivElement>(
  function PrintableBroadsheet(_props, ref) {
                    ...
                    return (
                      ...
                      >
                        ...
                        {pageSubjects.map((subject) => {
                          ...
                          return (
                            <Fragment
                              key={`prn-${student.id}-${subject.id}-group`}
                            >
                              {units.map((unit, unitIndex) => {
                                // `scores` positions follow the sorted-unit
                                // sequence — index matches this loop, NOT
                                // `unit.display_order`. See results.d.ts for
                                // the full array-position contract.
